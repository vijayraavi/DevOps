...
.PARAMETER component
The UiPath component that will be installed (Studio, Orchestrator or Robot). Defaults to Studio
...
param(
    ...
    [Parameter(ParameterSetName = "Install")]
    [ValidateSet("Studio", "Orchestrator","Robot")]
